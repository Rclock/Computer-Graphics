...
is being stored is a single array of 30 floats that represent two triangles.  The lower
left triangle of the rectangle and the upper right triangle.  For each of these 6 vertices
the array holds 5 floating point values of the form [r, g, b, x, y] where the (r, g, b) is
the color of the vertex and the (x, y) is the vertex position.
