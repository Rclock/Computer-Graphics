...
{
    LoadDataToGraphicsCard(vPosition, vColor, vNormal, vTex);
    reload = GL_TRUE;
}

/**
\brief Loads the object data to the graphics card assuming that
the positions of the vertices, colors, normals, tex coordinates are 0, 1, 2, 3
respectively.

*/

void Models::LoadDataToGraphicsCard()
{
    LoadDataToGraphicsCard(0, 1, 2, 3);
}
...
void Models::LoadDataToGraphicsCard(GLint v, GLint c, GLint n, GLint t)
{
    vPosition = v;
    vColor = c;
    vNormal = n;
