...
private:
    ...
    void processMouseButtonReleased(sf::Event::MouseButtonEvent mouseButtonEvent);
     ...
     sf::Clock UIGameClock;  ///< SFML clock to control the speed of the user interface.
    float UItime;           ///< Current timestamp of the user interface.
    float LastUItime;       ///< Last timestamp of the user interface.
    float t = 0;
    bool previous = true;
