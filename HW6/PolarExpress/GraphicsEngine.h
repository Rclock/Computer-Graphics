...
private:
    ...
    Ties ties;                     ///< Constructs an object containing all of the railroad ties.
    Track track1 = Track(9.6);     ///< Explicitly declares a track curve at a radius of 9.6
    Track track2 = Track(10);      ///< Explicitly declares a track curve at a radius of 10.0
    ...
    sf::Clock animclock;
    glm::mat4 RotateMat, TranslateMat, ScaleMat, RotateOuter;
    glm::mat4 model;
